  ...
  return (
    <div className='h-fit w-screen w-min-screen flex flex-col overflow-x-hidden relative'>
      ...
      <div className='flex-col flex items-center h-full w-full z-10 justify-start'>
        ...
        <div className='h1 align-middle w-fit sm:w-screen lg:text-6xl md:text-4xl text-3xl font-extrabold'>
        ...
        <div className='lg:w-1/2 mb-7 font-semibold sm:w-[90%] '>
        ...
        <div className='w-fit'>
          <button
            type='button'
            onClick={onOpen}
            className='py-3 px-10 font-bold text-white hover:bg-[#2F3C7E] bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-md .5 text-center mr-3 '
          >
            Get graphIQal
          </button>
        </div>
        <div className='w-full mx-auto my-12'>
          ...
          <div className='w-full mb-3'>
            <img
              className={
                'mx-auto h-auto lg:w-2/3 w-[90%] drop-shadow-xl rounded-md border border-lining'
              }
              src={Header}
            />
          </div>
